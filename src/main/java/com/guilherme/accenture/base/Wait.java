...
import com.guilherme.accenture.util.StringUtils;
...
import static com.guilherme.accenture.base.Page.pegarURLAtual;
...
public class Wait {
    ...
    private static Boolean waitConditions(String timeOutMessage, Integer timeout, Supplier<Boolean>[] waitConditions, Boolean waitType) {
        ...
        esperar(100);//Não retirar, isso não deixa o Selenium querer proceguir antes do necessário.
